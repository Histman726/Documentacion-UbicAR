...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.60\textwidth]{Realidad Aumentada.jpg}
	\caption{Ejemplo de uso de la AR}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.60\textwidth]{Evolucion de AR.png}
	\caption{Historia de la realidad aumentada}
	\label{fig:historia-AR}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.5\textwidth]{Elementos AR}
    \caption{Elementos de la realidad virtual}
    \label{fig:elementos}
\end{figure}
...
\subsection{Tipos de realidad aumentada}
	...
	Dado que se pueda acceder a este tipo de realidad aumentada en cualquier momento y desde cualquier dispositivo,
	es el modelo de realidad aumentada más flexible y accesible. \\
	
	\begin{figure}[H]
		\centering
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{marcadores QR.jpg}
			\caption{Marcador QR}
			\label{fig:marcador-QR}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{world tracking.jpg}
			\caption{World Tracking}
			\label{fig:world-tracking}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{face tracking.jpg}
			\caption{Face Tracking}
			\label{fig:face-tracking}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{body tracking.jpg}
			\caption{Body Tracking}
			\label{fig:body-tracking}
		\end{subfigure}
		\caption{Tipos de marcadores}
...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.5\textwidth]{juegos AR}
		\caption{Videojuegos AR}
