...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{imagenes/mapa.webp}
    \caption{Vista general del campus UPIICSA, contexto espacial del sistema UbicAR.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth]{art4.png}
