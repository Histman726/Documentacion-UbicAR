...
\vspace{-0.5em}
	...
	\label{tab:requerimientos_nofuncionales} \\
		...
		\hline
		\textbf{RNF02} & \textbf{Accesibilidad} \\
		\hline
		...
		\hline
		\textbf{RNF03} & \textbf{Sobrecarga Cognitiva} \\
		\hline
		...
		\hline
		\textbf{RNF04} & \textbf{Tiempo de Carga} \\
		\hline
		...
		\hline
		\textbf{RNF05} & \textbf{Latencia de AR} \\
		\hline
		...
		\hline
		\textbf{RNF06} & \textbf{Búsqueda Rápida} \\
		\hline
		...
		\hline
		\textbf{RNF07} & \textbf{Consumo de Batería} \\
		\hline
		...
		\hline
		\textbf{RNF08} & \textbf{Precisión de Ubicación} \\
		\hline
		...
		\hline
		\textbf{RNF09} & \textbf{Modo Offline} \\
		\hline
		...
		\hline
		\textbf{RNF10} & \textbf{Disponibilidad del Servicio} \\
		\hline
		...
		\hline
		\textbf{RNF11} & \textbf{Sistemas Operativos} \\
		\hline
		...
		\hline
		\textbf{RNF13} & \textbf{Fallback para dispositivos no compatibles} \\
		\hline
		...
		\hline
		\textbf{RNF14} & \textbf{Actualización de Datos} \\
		\hline
		...
		\hline
		\textbf{RNF15} & \textbf{Sincronización} \\
		\hline
		...
		\hline
		\textbf{RNF16} & \textbf{Datos en Tránsito} \\
		\hline
		...
		\hline
		\textbf{RNF17} & \textbf{Privacidad de Datos} \\
		\hline
